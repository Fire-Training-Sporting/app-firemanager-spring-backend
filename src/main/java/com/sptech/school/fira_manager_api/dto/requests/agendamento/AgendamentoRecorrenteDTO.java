...
@Schema(description = "DTO para criação de agendamentos recorrentes")
public class AgendamentoRecorrenteDTO extends AgendamentoDTO {

    @Schema(
        description = "Quantidade de agendamentos recorrentes a serem criados",
        example = "3"
    )

...
public class ServicoController {
    ...
    @GetMapping
    public ResponseEntity<List<ServicoResponse>> buscarServicos() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ServicoResponse> buscarServicosPorId(@PathVariable Long id) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ServicoResponse> atualizarAtividadePorId(@PathVariable Long id, @Valid @RequestBody ServicoRequest dto) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Serviço deletado com sucesso", content = @Content),
            @ApiResponse(responseCode = "404", description = "Serviço não encontrado", content = @Content)
    })
    @DeleteMapping("/{id}")
